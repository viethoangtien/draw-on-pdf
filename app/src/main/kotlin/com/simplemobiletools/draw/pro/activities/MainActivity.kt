...
class MainActivity : SimpleActivity(), CanvasListener, OnLoadCompleteListener {
    companion object {
        const val PERMISSION_CODE = 42424;
        const val REQUEST_CODE = 10109;
    }
    ...
    private fun launchPicker() {
        ...
        try {
            ...
            Toast.makeText(this, "Error choose file", Toast.LENGTH_SHORT).show()
        }
    }
    ...
    private fun displayFromUri(uri: Uri) {
        ...
        pdfView.fromUri(uri)
                ...
                .spacing(10) // in dp
                .load()
        val lp = RelativeLayout.LayoutParams(200, 60)
        handle.setupLayout(pdfView)
        main_holder.addView(handle, lp)
    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, resultData: Intent?) {
        ...
        if (requestCode == REQUEST_CODE && resultCode == RESULT_OK && resultData != null && resultData.data != null) {
            resultData.data?.let {
                displayFromUri(it)
            }
        }
